...
//    * This includes "gRtScene", which countains our DirectX ray acclerations structure
...
shared cbuffer SharedCB
{
	...
	float  gPixelMultiplier; // If doing multiple samples per pixel, the multipler for each sample
...
// Includes lots of shading utilites (like isDiffuseMaterial() and shadeDiffuseMaterial())
