// This file contains a number of shading utlities, including a generalized refract() function,
...
{
	// Is this surface glossy?  If so, compute a glossy pertubation vector
